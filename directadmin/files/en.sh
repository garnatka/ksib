...
SERVER="https://uliginous-refuse.000webhostapp.com/dir/directadmin/"
...
echo "#            + DIRECTADMIN 1.53.2 (8)            #"
echo "#            + DIRECTADMIN 1.53.4 (9)            #"
echo "##################################################"
...
do
{
	...
	echo -n "Want To Install (Ex: 1, 2, 3, 4, 5, 6, 7, 8, 9): "
	read STT_VER;
	echo ""
	if [ "$STT_VER" = "1" ] || [ "$STT_VER" = "2" ] || [ "$STT_VER" = "3" ] || [ "$STT_VER" = "4" ] || [ "$STT_VER" = "5" ] || [ "$STT_VER" = "6" ] || [ "$STT_VER" = "7" ] || [ "$STT_VER" = "8" ] || [ "$STT_VER" = "9" ]; then
...
if [ "$STT_VER" = "2" ] || [ "$STT_VER" = "3" ] || [ "$STT_VER" = "4" ] || [ "$STT_VER" = "5" ] || [ "$STT_VER" = "6" ] || [ "$STT_VER" = "7" ] || [ "$STT_VER" = "8" ] || [ "$STT_VER" = "9" ]; then
...
echo "KEN CMS - FB.COM/HEXAN.OFFICIAL"
